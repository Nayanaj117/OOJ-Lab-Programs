/*Develop a java program to create a class Actor with id, name,no_of_years,
no_of_movies.Calculate the average performance of each actor and print name of actor with highest average*/
